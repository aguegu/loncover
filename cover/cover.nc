...
// Run on Thu Sep 26 09:31:20 2013, version 4.01.07
//
...
// Description:
//
// cover.nc is the device's main Neuron C source file, which
// automatically includes other application-specific Neuron C source or header
// files as necessary. The cover.nc file also contains the
...
when (usart_available()) {
    ...
    if (cs_calc == cs_recv && address_recv == (uint8_t) nviAddressRs485) {
...
// system_image_extensions pragma, see cover.h.
